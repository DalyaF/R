...
https://github.com/dodoram/seqTp.git
...
16. Si un readem s'est malgré tout créé et que la fusée en baoooykgfs à droite du tableau de votre repo n'apparait pas, effacer le readme, etle bouton environnement en bas à droite de la page avec une fusée apparait
...
Dans le projet du livre, vous pouvez rajouter des chapitres en ouvrant un nouveau rmarkdown et en le sauvegardant dans le dossier du projet. Pour l'ajouter au reste du livre, ouvrir le dossier _bookdown.yml et rajouter le nom du chapter suivi de .Rmd dans les crochets de la section yaml rmd_files :[""]. Modifiez à l'envie les chapitres existants comme dans un rmarkdown.
